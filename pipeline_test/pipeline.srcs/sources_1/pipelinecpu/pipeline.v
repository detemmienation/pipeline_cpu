...
module EX(
    ...
    input         rst,
    // to EX
    input  [31:0] ALU_A,       // ALU ??? A
    input  [31:0] ALU_B,       // ALU ??? B
    input  [4:0]  ALUOp,       // ALU ????

    // to MEM
    input  [31:0] PC_in,
    input  [31:0] immout_in,   // ??????????
    input  [2:0]  NPCOp_in,    // next PC ????
...
module MEM(
    ...
    reg [31:0] dtmp;//作为初始数据，代指raw_Data_in
    reg [31:0] Data_in;
